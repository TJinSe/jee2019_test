...
public class RAdminSelectAdminAction extends ActionSupport {
    Connection con;
    Statement sql;
    ResultSet rs;
    ...
    public String execute() throws Exception{
        ...
        String condition="SELECT RANumber,RAName,RASex,RAPhone from roomadmins";
        ...
        {
            found=2;
            System.out.println("查看宿管信息失败:"+e.toString());
        }
        if(found==1)
        {
            return "suc";
