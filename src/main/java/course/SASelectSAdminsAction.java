...
public class SASelectSAdminsAction extends ActionSupport {
    Connection con;
    Statement sql;
    ResultSet rs;
    ...
    public String execute() throws Exception{
        ...
        String condition="SELECT SANumber,SAName,SASex,SAPhone from superAdmins";
        ...
        {
            found=1;
            System.out.println("信息查看失败:"+e.toString());
        }
